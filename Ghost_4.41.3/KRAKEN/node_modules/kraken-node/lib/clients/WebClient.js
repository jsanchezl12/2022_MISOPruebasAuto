...
var WebClient = /** @class */ (function (_super) {
    ...
    function WebClient(browserName, otherParams, id) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.createInbox();
                        _a = this;
                        return [4 /*yield*/, webdriverio_1.remote({
    ...
    WebClient.prototype.capabilities = function () {
        return __assign({ browserName: this.browserName }, this.otherParams);
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.deleteInbox();
                        return [4 /*yield*/, this.browser.deleteSession()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
